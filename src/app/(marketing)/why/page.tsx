            ...
            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
              ...
              <div className="my-12">
                <motion.h2
                  ...
                  viewport={{ once: true, margin: "-100px" }}
                  transition={{ duration: 0.6, ease: "easeOut" }}
                  className="text-5xl md:text-7xl lg:text-8xl font-serif leading-tight text-left max-w-3xl mx-auto"
                  style={{ lineHeight: '1.1' }}
                >
                  <span className="block ml-0 md:ml-4">Say</span>
                  <span className="block ml-12 md:ml-20 lg:ml-28">hello to</span>
                  <span className="block text-6xl md:text-8xl lg:text-9xl italic ml-6 md:ml-12 lg:ml-16 my-1 text-red-600 [text-shadow:0_0_30px_rgba(239,68,68,0.5),0_0_60px_rgba(239,68,68,0.3)]">
                    ClypAI,
                  </span>
                  <span className="block ml-16 md:ml-32 lg:ml-40">your shortcut</span>
                  <span className="block ml-8 md:ml-16 lg:ml-20">to the feed.</span>
                </motion.h2>
              </div>
              ...
              <motion.p
                ...
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.6, ease: "easeOut" }}
                className="mx-auto mt-12 max-w-xl text-balance text-xl font-semibold text-foreground font-mono text-red-600"
              >
