          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
              ...
              >
                ...
                marathon stream, knowing there are gold nuggets buried inside,
                but the thought of digging them out feels like a mountain you
                aren&apos;t ready to climb. You want to share your best moments,
                but instead, you&apos;re staring at a timeline, bogged down by
                the friction of manual editing. This is where the spark of
                creativity usually goes to die: in the tedious middle ground
                between recording and posting.
              </motion.p>
              ...
              >
                ...
                using to create. You get lost in the mechanics—syncing
                subtitles, repositioning frames, hunting for the right
                emoji—until the joy of sharing your message is replaced by the
                fatigue of the &quot;grind.&quot;
              </motion.p>
              ...
              <motion.p
                ...
                className="mx-auto mt-6 sm:mt-8 max-w-xl text-balance text-base sm:text-lg text-muted-foreground font-mono px-4 sm:px-0"
              >
                But what if you could extract the viral potential of your
                content without the manual labor? Identify the hooks, without
                re-watching the whole session? Apply perfect subtitles, without
                typing a single word? Or reframe your best angles for vertical
                screens, without wrestling with complex software?
              </motion.p>
              ...
              <div className="my-8 sm:my-12 px-4">
                ...
                >
                  ...
                  <span className="block ml-8 sm:ml-12 md:ml-20 lg:ml-28">
                    hello to
                  </span>
              ...
              <motion.p
                ...
                className="mx-auto mt-6 sm:mt-8 max-w-xl text-balance text-base sm:text-lg text-muted-foreground font-mono px-4 sm:px-0"
              >
                It allows you to transform long-form depth into short-form
                impact instantly. A new way of thinking about your content
                library, where your archives aren&apos;t just storage—they are a
                limitless source of engagement.
              </motion.p>
              ...
              >
                ...
                curation for you. It&apos;s a fresh way of working that shifts
                the focus from the &quot;how&quot; to the &quot;what.&quot; Once
                you see your content through this lens, you can never go back.
              ...
              >
                ...
                speed is the ultimate competitive advantage. It&apos;s a vision
                of content creation where the tools serve the storyteller, not
              ...
              >
                The choice is yours: get buried in the timeline or start
                trending.
              </motion.p>
              ...
              >
                ...
                to turn your long-form into a legacy.
              </motion.p>
            </div>
          </div>
        </div>
